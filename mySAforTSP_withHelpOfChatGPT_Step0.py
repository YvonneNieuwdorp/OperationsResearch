...
Prompt:
    I want to implement the simulated annealing optimization technique 
    to the traveling salesman problem. can you give python code for this?
"""
    ...
    while temperature > 1e-3:
        for _ in range(iterations_per_temp):
            ...
            if delta < 0 or random.random() < math.exp(-delta / temperature):
                ...
                # WILR: Added this line to show live progress in Terminal
