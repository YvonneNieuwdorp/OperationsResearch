...
def nearest_neighbor(current_time_m1, current_time_m2, available_orders, current_colour_m1, current_colour_m2):
    ...
    for index, order in available_orders.iterrows(): 
        time_to_finish_m1 = current_time_m1 + processing_time(index, 1)
        ...
        time_to_finish_m2 = current_time_m2 + processing_time(index, 2)
...
while not available_orders.empty:
    next_order_idx, best_machine = nearest_neighbor(current_time_m1, current_time_m2, available_orders, current_colour_m1, current_colour_m2)
    ...
    if next_order_idx is not None:
        ...
        if best_machine == "M1":
            ...
            current_time_m1 += processing_time(next_order_idx, 1)
            ...
            current_time_m2 += processing_time(next_order_idx, 2)
